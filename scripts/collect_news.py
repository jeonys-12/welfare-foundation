...
OFFICIAL_LAW_BASELINES=[
 ...
 ("corporate_tax","공익법인의 설립ㆍ운영에 관한 법률","공익법인의 설립·운영과 감독에 관한 기본 사항을 정한 현행 법률입니다.","국가법령정보센터","https://www.law.go.kr/법령/공익법인의설립·운영에관한법률"),
 ("corporate_tax","공익법인의 설립ㆍ운영에 관한 법률 시행령","공익법인의 설립·운영과 감독에 필요한 세부 사항을 정한 현행 시행령입니다.","국가법령정보센터","https://www.law.go.kr/법령/공익법인의설립·운영에관한법률시행령"),
